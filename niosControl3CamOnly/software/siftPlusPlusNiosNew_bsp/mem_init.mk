...
$(MEM_0)_START := 0x01104000
$(MEM_0)_END := 0x01107fff
$(MEM_0)_HIERARCHICAL_PATH := onchip_cache
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_cache
onchip_cache: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_reset_and_exception
MEM_1 := onchip_reset_and_exception
$(MEM_1)_NAME := onchip_reset_and_exception
...
$(MEM_1)_START := 0x01109200
$(MEM_1)_END := 0x011093ff
$(MEM_1)_HIERARCHICAL_PATH := onchip_reset_and_exception
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_reset_and_exception
onchip_reset_and_exception: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
